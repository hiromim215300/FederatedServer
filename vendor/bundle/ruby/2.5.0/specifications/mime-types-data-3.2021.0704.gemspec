# -*- encoding: utf-8 -*-
# stub: mime-types-data 3.2021.0704 ruby lib

Gem::Specification.new do |s|
  s.name = "mime-types-data".freeze
  s.version = "3.2021.0704"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rake>.freeze, ["< 14", ">= 10.0"])
      ...
      s.add_dependency(%q<rake>.freeze, ["< 14", ">= 10.0"])
